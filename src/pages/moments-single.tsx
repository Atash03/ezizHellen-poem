    ...
    <PageLayout title={"Pursatlar"} className="gap-8">
      <div className="relative w-full xl:h-[504px] md:h-[436px] md:shadow-bottom py-8 md:px-6">
        ...
        <div className="flex md:flex-row flex-col xl:gap-6 gap-8">
          <button
            onClick={() => setSrc(data?.main_image?.path)}
            className="xl:flex-[0_0_675px] md:flex-[0_0_420px] xl:h-[379px] md:h-[235px] md:bg-[#7A590C]/[16%]"
          >
            <img
          ...
          >
            <img
              src={src}
              alt="surat"
              className="w-[70dvw] h-[70dvh] rounded-lg relative z-20 object-cover"
            />
          </dialog>
